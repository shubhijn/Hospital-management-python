...
class HOSPITAL_MANGMENT_checkin:
    ...
    def __init__(self):
        ...
        def chk_day():
            while True:
                ...
                if self.l.isdigit() == True and len(self.l) != 0:
                    ...
                    self.Text1.insert(INSERT, "age has been inputed""\n")
                    break
                else:
        ...
        self.Message3.configure(text='''PATIENT DETAILS''')
        ...
        self.Checkbutton1.configure(text='''PHYSICIAN''')
        ...
        self.Checkbutton2.configure(font=font10)
        ...
        self.Checkbutton2.configure(text='''PEDIATRICIAN''')
        ...
        self.Checkbutton3.configure(font=font10)
        ...
        self.Checkbutton3.configure(text='''SURGEON''')
        ...
        self.Checkbutton4.configure(font=font10)
        ...
        self.Checkbutton4.configure(text='''GYNECOLOGIST''')
        ...
        self.Label1.configure(text='''ENTER YOUR AGE''')
...
if __name__ == '__main__':
    hotel=HOSPITAL_MANGMENT_checkin()
