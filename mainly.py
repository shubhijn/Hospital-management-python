...
class HOSPITAL_MANAGEMENT:
    def __init__(self):
        ...
        self.Button2.configure(text='''1.PATIENT DETAILS''')
        ...
        self.Button3.configure(text='''2.PATIENT LIST''')
        ...
        self.Button4.configure(text='''3.DELETE APPOINTMENT''')
        ...
        self.Button5.configure(text='''4.PATIENT INFO''')
