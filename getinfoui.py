    ...
    def __init__(self):
        def gotinfo():
            ...
            if self.gettininfo.isdigit() == True and len(self.gettininfo) != 0:
                self.Text1.insert(INSERT, " VALID APPOINTMENT NUMBER ""\n")
            else :
                self.Text1.insert(INSERT,"INVALID APPOINTMENT NUMBER""\n")
            ...
            try:
                ...
                while True:
                    ...
                    if self.gettininfo == a:
                        ...
                        print("\n")
                        print("TOTAL BILL IS Rs.", s.price)
                    elif EOFError:
                        if n == 0:
                            print("PATIENT NUMBER ", self.gettininfo)
                        else:
                            n = 0
                            continue
            except EOFError:
        ...
        self.Label1.configure(text='''ENTER THE APPT. NO.   :''')
